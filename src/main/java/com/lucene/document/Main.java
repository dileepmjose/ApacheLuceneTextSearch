...
public class Main {
    ...
    private static final String INDEX_DIR = "DocumentIndex";
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        DocumentIndexWriter indexer = new DocumentIndexWriter(INDEX_DIR);
        ...
        DocumentIndexSearch searcher = new DocumentIndexSearch(INDEX_DIR);
